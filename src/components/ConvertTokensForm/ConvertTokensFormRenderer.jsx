      ...
      <BalancesGroup>
        ...
        <BalancesBox>
          <BalanceBox>
            ...
            <h2>
              {formatNumber(Number(fromTokenBalance) - convertAmount, {
                precision: 3
              })}{' '}
              {fromToken}
            </h2>
          ...
          <BalanceBox>
            <h2>
              {formatNumber(Number(toTokenBalance) + convertAmount, {
                precision: 3
              })}{' '}
              {toToken}
            </h2>
      ...
      return (
        <ModalBody>
          <ConfirmBox>
            ...
            <h4>
              There was a problem with your transaction. But no worries, your
              funds are safe
            </h4>
          </ConfirmBox>
          <TxNotificationBox>
      ...
      return (
        <ModalBody>
          <ConfirmBox>
            ...
            <h3>
              Your {fromToken} has been successfully tokenized. You can now
              start trading
            </h3>
            <Button minimal onClick={reset}>
              Convert again
