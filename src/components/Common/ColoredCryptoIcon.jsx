...
const ColoredCryptoIcon = ({ name, color, size }) => {
  ...
  switch (name) {
    ...
    case 'AE':
      return <AE width={size} height={size} viewBox="0 0 32 32" />
    case 'AION':
      return <AION width={size} height={size} viewBox="0 0 32 32" />
    case 'BAT':
      return <BAT width={size} height={size} viewBox="0 0 32 32" />
    case 'BNB':
      return <BNB width={size} height={size} viewBox="0 0 32 32" />
    case 'BTM':
      return <BTM width={size} height={size} viewBox="0 0 32 32" />
    case 'FUN':
      return <FUN width={size} height={size} viewBox="0 0 32 32" />
    case 'GNT':
      return <GNT width={size} height={size} viewBox="0 0 32 32" />
    case 'KCS':
      return <KCS width={size} height={size} viewBox="0 0 32 32" />
    case 'KNC':
      return <KNC width={size} height={size} viewBox="0 0 32 32" />
    case 'LOOM':
      return <LOOM width={size} height={size} viewBox="0 0 32 32" />
    case 'LRC':
      return <LRC width={size} height={size} viewBox="0 0 32 32" />
    case 'MITH':
      return <MITH width={size} height={size} viewBox="0 0 32 32" />
    case 'MKR':
      return <MKR width={size} height={size} viewBox="0 0 32 32" />
    case 'NPXS':
      return <NPXS width={size} height={size} viewBox="0 0 32 32" />
    case 'OMG':
      return <OMG width={size} height={size} viewBox="0 0 32 32" />
    case 'PPT':
      return <PPT width={size} height={size} viewBox="0 0 32 32" />
    case 'DAI':
      return <DAI width={size} height={size} viewBox="0 0 32 32" />
    case 'USDC':
      return <USD width={size} height={size} viewBox="0 0 32 32" />
    case 'REP':
    ...
    case 'TUSD':
      return <TUSD width={size} height={size} viewBox="0 0 32 32" />
    case 'WTC':
      return <WTC width={size} height={size} viewBox="0 0 32 32" />
    case 'ETH':
